...
import {
  UtensilsCrossed, Plus, CalendarDays, LogOut, Sparkles,
                    ...
                    <CardContent className="p-5">
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          <h3 className="font-medium truncate" data-testid={`text-plan-title-${mp.id}`}>{plan?.title || "Meal Plan"}</h3>
                          <p className="text-sm text-muted-foreground line-clamp-2 mt-1">{plan?.summary || "7-day personalized meal plan"}</p>
